    ...
    <div>
      ...
      <div className="container">
        <div className="mx-auto max-w-[380px] mt-[10%] sm:mt-[5%] animate__animated animate__fadeInUp">
          ...
          <h2 className="uppercase text-center sm:mb-2 font-[500] text-[24px] sm:text-[36px]">
            Login
          </h2>
          ...
          >
            <Form className="w-full sm:border border-solid border-black/20 shadow-[0_0_20px_0_rgba(0,0,0,0.0.05)] p-[30px] bg-white rounded-[5px]">
              <div className="mb-3">
